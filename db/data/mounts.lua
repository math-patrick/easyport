Mounts = {{
    ...
    keywords = {"brutosaur", "bruto", "auction", "ah", "longboy", "vendor",  "aromatise"},
    legacy = 1
}, {
    ...
    keywords = {"brutosaur", "bruto", "auction", "ah", "longboy", "mailbox", "mail", "aromatise"}
}, {
    name = "Grizzly Hills Packmaster",
    spellID = 457485,
    mountId = 2237,
    spellName = "Grizzly Hills Packmaster",
    actionType = "mount",
    category = "Utility",
    cooldown = "No CD",
    destination = "Repair & Transmog",
    keywords = {"repair", "vendor", "transmog"}
}}
