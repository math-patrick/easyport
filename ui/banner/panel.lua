...
local function CreateBannerIcon(parent)
    ...
    local iconFrame = IconRenderer.CreateIconFrame(parent, 36)
...
local function CreateBannerText(parent, iconFrame)
    ...
    title:SetPoint("LEFT", iconFrame, "RIGHT", -4, 8)
    title:SetPoint("RIGHT", parent, "RIGHT", -64, 0)
    title:SetTextColor(unpack(Constants.BANNER_COLORS.TEXT_NORMAL))
    ...
    subtitle:SetPoint("RIGHT", parent, "RIGHT", -64, 0)
...
function BannerUI.CreateBanner()
    ...
    inner:SetPoint("TOPLEFT", 7, -7)
    inner:SetPoint("BOTTOMRIGHT", -7, 7)
    inner:SetVertexColor(1, 1, 1, 0.88)
    ...
    dragButton:SetScript("OnDragStop", function()
        ...
        banner:SetPoint(point or "CENTER", UIParent, relativePoint or "CENTER", xOfs or 0, yOfs or 0)
